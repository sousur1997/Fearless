...
public class ContactUpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intent = getIntent();
        contactNameEd.setText(intent.getStringExtra(FearlessConstant.CONTACT_NAME_EXTRA));
        contactPhoneEd.setText(intent.getStringExtra(FearlessConstant.CONTACT_PHONE_EXTRA));
        index = intent.getIntExtra(FearlessConstant.CONTACT_LIST_INDEX_EXTRA, -1);
    ...
    private void updateTask(){
        ...
        sendBack.putExtra(FearlessConstant.CONTACT_NAME_CHANGE_EXTRA, contactNameEd.getText().toString());
        sendBack.putExtra(FearlessConstant.CONTACT_PHONE_CHANGE_EXTRA, contactPhoneEd.getText().toString());
        sendBack.putExtra(FearlessConstant.CONTACT_LIST_INDEX_EXTRA, index);
